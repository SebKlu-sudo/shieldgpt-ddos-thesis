...
for attack_type in "${attack_types[@]}"; do
    ...
    /usr/ShieldGPT/pcap_tool/splitter -i "../pcap/attack/${attack_type}.pcap" -o "../pcap/flow_pcap_5_tuple/${attack_type}" -f five_tuple -l $flow_packet_limit
done
